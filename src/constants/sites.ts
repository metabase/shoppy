...
export const SITES: SiteInfo[] = [
  { title: "Shop 1", key: "stitch", icon: "iconoir:shirt", shopId: 2 },
  { title: "Shop 2", key: "luminara", icon: "streamline:lipstick", shopId: 3 },
  { title: "Shop 3", key: "pug", icon: "lucide:dog", shopId: 1 },
]
